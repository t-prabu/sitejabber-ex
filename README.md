...
6. We expect you use BEM methodology for the HTML structure and CSS. We use a loose approach on the naming convention for elements so don't overthink it.
7. All styles must be on written on SCSS.
